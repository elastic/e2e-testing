...
pipeline {
  ...
  parameters {
    string(name: 'ELASTIC_AGENT_VERSION', defaultValue: "8.6.3-SNAPSHOT", description: 'SemVer version of the Elastic Agent to be used for the tests. You can use here the tag of your PR to test your changes')
    string(name: 'ELASTIC_STACK_VERSION', defaultValue: "8.6.3-SNAPSHOT", description: 'SemVer version of the stack to be used for the tests.')
    string(name: 'BEAT_VERSION', defaultValue: "8.6.3-SNAPSHOT", description: 'SemVer version of the Beat to be used for the tests. You can use here the tag of your PR to test your changes')
