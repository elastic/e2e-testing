...
This is an example of the optional configuration:
   ...
   export STACK_VERSION=7.9.1
   # (Fleet mode) This environment variable will use a fixed version of the Elastic agent binary, obtained from
   # https://artifacts-api.elastic.co/v1/search/7.9.1/elastic-agent
   export ELASTIC_AGENT_DOWNLOAD_URL="https://staging.elastic.co/7.9.1-7b774025/downloads/beats/elastic-agent/elastic-agent-7.9.1-linux-x86_64.tar.gz"
